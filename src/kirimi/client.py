...
class Kirimi:
    ...
    def waba_reply(
        ...
        return self._post("/v1/waba/messages/reply", req.model_dump())

    def waba_conversations(
        self,
        limit: int | None = None,
        page: int | None = None,
    ) -> KirimiResponse:
        ...
        return self._post("/v1/waba/conversations", req.model_dump())

    def waba_templates_sync(self, waba_id: str) -> KirimiResponse:
        ...
        return self._post("/v1/waba/templates/sync", req.model_dump())
    ...
    def waba_send_otp(
        ...
        return self._post("/v1/waba/send-otp", req.model_dump())
    ...
    def waba_verify_otp(
        ...
        return self._post("/v1/waba/verify-otp", req.model_dump())
    ...
    def create_device(
        ...
        return self._post("/v1/create-device", req.model_dump())

    def connect_device(self, device_id: str) -> KirimiResponse:
        ...
        return self._post("/v1/connect-device", req.model_dump())
    ...
    def renew_device(
        ...
        return self._post("/v1/renew-device", req.model_dump())

    def list_devices(self, page: int | None = None, limit: int | None = None) -> KirimiResponse:
        ...
        body["page"] = page
        body["limit"] = limit
        return self._post("/v1/list-devices", body)
    ...
    def save_contacts_bulk(
        ...
        return self._post("/v1/save-contacts-bulk", req.model_dump())
    ...
    def otp_reverse_create(
        ...
        return self._post("/v2/otp-reverse/create", req.model_dump())

    def otp_reverse_status(self, token: str) -> KirimiResponse:
        ...
        return self._post("/v2/otp-reverse/status", req.model_dump())
    ...
    def create_deposit(self, nominal: float | int) -> KirimiResponse:
        ...
        return self._post("/v1/create-deposit", req.model_dump())

    def deposit_status(self, ref: str) -> KirimiResponse:
        ...
        return self._post("/v1/deposit-status", req.model_dump())

    def cancel_deposit(self, ref: str) -> KirimiResponse:
        ...
        """
        req = DepositRefRequest(**self._auth(), ref=ref)
        return self._post("/v1/cancel-deposit", req.model_dump())
